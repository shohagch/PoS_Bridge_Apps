...
// File: contracts/root/RootToken/SeliseERC20.sol

pragma solidity ^0.8.14;
contract SeliseERC20 is ERC20, NetworkAgnostic, ChainConstants {
    constructor() public
        ERC20("SELISE ERC20 ", "xBDT")
        NetworkAgnostic("SELISE ERC20", ERC712_VERSION, ROOT_CHAIN_ID)
    {
