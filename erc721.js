...
async function approveandtransfer() {
    ...
    //const rootToken = "0x084297B12F204Adb74c689be08302FA3f12dB8A7"; // this is taken from matic docs and discussed below
   ...
   // Above addresses are taken from matic docs and discussed below
    ...
    await maticPOSClient.approveERC721ForDeposit(rootToken, amount, { from: from });
    console.log(" Log Checking ");

    console.log("approve completed and transfer initiated");

    await maticPOSClient.depositERC721ForUser(rootToken, from, amount, {
        from: from,
